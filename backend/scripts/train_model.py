...
def train_random_forest(X_train, X_test, y_train, y_test):
    ...
    # Compute results
    initial_accuracy_test, initial_f1_test, optimized_accuracy_test, optimized_f1_test = calculate_model_results("Random Forest", y_train, y_test, rf_initial, best_rf, X_train, X_test)

    return rf_initial, best_rf, initial_accuracy_test, initial_f1_test, optimized_accuracy_test, optimized_f1_test, grid_search.best_params_
...
def train_decision_tree(X_train, X_test, y_train, y_test):
    ...
    # Compute results
    initial_accuracy_test, initial_f1_test, optimized_accuracy_test, optimized_f1_test = calculate_model_results("Decision Tree", y_train, y_test, dt_initial, best_dt, X_train, X_test)

    return dt_initial, best_dt, initial_accuracy_test, initial_f1_test, optimized_accuracy_test, optimized_f1_test, grid_search.best_params_
...
def calculate_model_results(model_name, y_train, y_test, model_initial, model_optimized, X_train, X_test):
    ...
    return initial_accuracy_test, initial_f1_test, optimized_accuracy_test, optimized_f1_test
